...
in {
  ...
  containers.minecraft-servers = {
    ...
    forwardPorts = [
      {
        containerPort = ports.minecraft.s1;
        hostPort = ports.minecraft.s1;
      }
      {
        containerPort = ports.minecraft.rcon;
        hostPort = ports.minecraft.rcon;
      }
    ];
    bindMounts = {
  ...
  containers.personalWebpage = {
    ...
    bindMounts = {
      "/var/lib/personalWebpage" = {
        hostPath = "/var/lib/personalWebpage";
        isReadOnly = true;
      };
    };
  ...
  containers.nextcloud = {
    ...
    bindMounts = {
      ...
      "/etc/nextcloud-admin-pass" = {
        hostPath = "/etc/nextcloud-admin-pass";
        isReadOnly = true;
      };
    };
    config = {
